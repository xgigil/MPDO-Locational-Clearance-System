      ...
      <section className="section hero">
        <div className="container hero-grid">
          <div className="about-copy" id="about-hero">
            ...
            <p>
              As part of its commitment to improving public service delivery, the office adopted a Web-Based
              Automated Location Clearance System that streamlines applications and monitoring of location
              clearance requests in accordance with the municipality&apos;s zoning ordinance and development plans.
            </p>
          </div>

          <div className="about-card">
            <div className="about-card-inner">
              <img className="about-card-image" alt="MPDO Alubijid details" src="/mpdo details.jpg" />
            </div>
          </div>
        </div>
      </section>
            ...
            <Link className="service-card" to="/Application">
              <div className="service-card-body">
                ...
                <p className="service-desc">
                  Location Clearance, Zoning Certification, Subdivision, Projects with Required Location Guidelines
                  and Standards
                </p>
              </div>
